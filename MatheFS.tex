...
% ----------------------------------------------------------------------
\begin{eqnarray*}
	\underset{\text{Harmonische Reihe}}{\sum_{n=1}^\infty \frac{1}{n} = \infty} \quad \underset{\text{Geometrische Reihe; $n=0$, notfalls Index verschieben}}{\sum_{n=0}^\infty q^n = \frac{1}{1-q}} |q|<1
\end{eqnarray*}
...
Intervall (reell) s: $a_n$ nach x auflösen $I=(R-s, R+s)$  \\
